...
import { decreaseQty, deleteItem, increaseQty } from '../redux/productSlice'
import {TbPlus} from 'react-icons/tb'
import {TbMinus} from 'react-icons/tb'


const CartItem = (props) => {
    const { id, image, name, price, category, qtn, total } = props
    ...
    <div className="bg-slate-200 p-2 flex gap-4 rounded border border-slate-300">
      ...
      <div className="flex flex-col gap-1 w-full">
        <div className="flex justify-between">
          ...
          <div className="cursor-pointer text-slate-700 hover:text-red-500" onClick={()=>dispatch(deleteItem(id))}>
            <MdDeleteOutline />
          </div>
        </div>
        ...
        <div className="flex justify-between ">
          <div className="flex gap-3 items-center">
            ...
            <p className="font-semibold p-1">{qtn}</p>
